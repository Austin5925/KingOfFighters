...
export class Player extends AcGameObject {
    constructor(root, info) {
        ...
        this.status = 3; //0:idle; 1:front ; 2:back ; 3:jump ; 4:attack ;5:gethit ; 6:gg
        ...
        if(this.status === 4 && this.frame_current_cnt === 18){
            ...
            if(this.direction > 0){
                r1 = {
                    x1 : me.x + 120,
                    x2 : me.x + 120 + 105,
                    y1 : me.y + me.height - 160,
                    y2 : me.y + me.height - 160 + 20,
                }
            }else {
                r1 = {
                    x1 : me.x + me.width - 205 - 20,
                    x2 : me.x + me.width - 205 - 20 + 105,
                    y1 : me.y + me.height - 160,
                    y2 : me.y + me.height - 160 + 20,
                }
            }
    ...
    render(){
        ...
        //     this.ctx.fillRect(this.x + 120, this.y + this.height - 160, 105, 20);    
        // }else{
        //     this.ctx.fillStyle = "red"; 
        //     this.ctx.fillRect(this.x + this.width - 205 - 20, this.y + this.height - 160, 105, 20);    
        // }
